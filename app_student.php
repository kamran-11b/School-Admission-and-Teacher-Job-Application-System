...
if (isset($_SESSION["admin_email"]) || isset($_COOKIE['admin_email'])) {
    ...
    $fq = "SELECT * FROM `admission_student`";
    ...
    <head>
        <title>Application View Student</title>
        <meta charset="UTF-8">
                            ...
                            <table class="table table-condensed table-striped table-bordered">
                                ...
                                while ($row = $result->fetch_assoc()){?>
                                    <tr>
                                        ...
                                        <td> <?php echo $row['previous_result'] ?> </td>
                                        ...
                                        <td><a href="app_student_edit.php?admission_id=<?php echo $row['admission_id']; ?>" class="btn btn-info">Action</a> <a href="delete_app_st.php?admission_id=<?php echo $row['admission_id']; ?>" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php $i++; } ?>
                                </table>
                            <?php } ?>
